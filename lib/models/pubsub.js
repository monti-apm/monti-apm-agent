...
const logger = createLogger('kadira:pubsub');
...
PubsubModel.prototype._getSubscriptionInfo = function () {
  ...
  // let totalDocsSent = Object.create(null);
  // let totalDataSent = Object.create(null);
...
PubsubModel.prototype.incrementHandleCount = function (trace, isCached) {
  ...
  const session = getProperty(Meteor.server.sessions, trace.session);
...
PubsubModel.prototype.trackDeletedObserver = function (info) {
  ...
  publication.observerLifetime += getLocalTime() - info.startTime;
};
