...
PubsubModel.prototype.buildMetricsPayload = function () {
  ...
  for (let dateId of Object.keys(metricsByMinute)) {
    ...
    pubMetrics.push(metricsByMinute[dateId]);
  }

  return pubMetrics;
};

PubsubModel.prototype.buildTracesPayload = function () {
  return {
    pubRequests: this.tracerStore.collectTraces()
  };
};
