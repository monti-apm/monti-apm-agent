...
let METHOD_METRICS_FIELDS = ['wait', 'db', 'http', 'email', 'async', 'compute', 'total'];
...
MethodsModel.prototype.processMethod = function (methodTrace) {
  let dateId = this._getDateId(methodTrace.at);
...
MethodsModel.prototype._appendMetrics = function (id, methodTrace) {
  let methodMetrics = this._getMetrics(id, methodTrace.name);
