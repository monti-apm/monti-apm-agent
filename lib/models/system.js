...
export function SystemModel () {
  ...
  this.evloopMonitor.on('lag', lag => {
    ...
    // store as microsecond rounded to the nearest ROUNDING_FACTOR
    this.evloopHistogram.add(ROUNDING_FACTOR * Math.round(lagInMS / ROUNDING_FACTOR));
  });
