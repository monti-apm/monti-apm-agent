...
import { Ntp } from '../ntp';
import { AsyncMetrics } from '../async/async-hook';
...
SystemModel.prototype.buildPayload = function () {
  ...
  metrics.totalAsyncResources = AsyncMetrics.totalAsyncCount;
  metrics.activeAsyncResources = AsyncMetrics.activeAsyncCount;
