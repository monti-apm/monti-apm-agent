...
Kadira.connect = function (appId, appSecret, options) {
  ...
  options.enableClientTracking = options.enableClientTracking || false;
  ...
  __meteor_runtime_config__.kadira = {
    ...
    enableClientTracking: options.enableClientTracking,
  };
...
Kadira.enableClientTracking = function () {
  __meteor_runtime_config__.kadira.enableClientTracking = Kadira.options.enableClientTracking = true;
};
