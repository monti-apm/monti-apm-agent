...
Kadira.connect = function (appId, appSecret, options) {
  ...
  options.enableClientPerformanceTracking = options.enableClientPerformanceTracking || false;
  ...
  __meteor_runtime_config__.kadira = {
    ...
    enableClientPerformanceTracking: options.enableClientPerformanceTracking,
  };
...
Kadira.enableClientPerformanceTracking = function () {
  __meteor_runtime_config__.kadira.enableClientPerformanceTracking = Kadira.options.enableClientPerformanceTracking = true;
};
