...
import { runWithALS, runWithEnvironment } from '../als';
...
export function wrapSession (sessionProto) {
  ...
  sessionProto.protocol_handlers.method = runWithALS(function (msg, unblock) {
    let self = this;
    // add context
    ...
    if (kadiraInfo) {
      ...
      response = runWithEnvironment(function () {
