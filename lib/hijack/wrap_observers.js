...
export function wrapForCountingObservers () {
  ...
  mongoConnectionProto._observeChanges = async function (cursorDescription, ordered, callbacks) {
    let ret = await originalObserveChanges.call(this, cursorDescription, ordered, callbacks);
