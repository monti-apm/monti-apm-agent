...
let logger = require('debug')('kadira:ts');
...
// Used by tests
TracerStore.prototype._reset = function () {
  this.maxTotals = Object.create(null);
  this.currentMaxTrace = Object.create(null);
  this.traceArchive = [];
  this.processedCnt = Object.create(null);
...
TracerStore.prototype.addTrace = function (trace) {
  ...
  if (!this.currentMaxTrace[kind]) {
    ...
    if (this.currentMaxTrace[kind].errored) {
      // Make sure we still preserve this trace since it errored
      this._handleErrors(this.currentMaxTrace[kind]);
    }
