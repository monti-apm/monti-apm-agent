...
import { getResourcesAsArray } from '../async/async-hook';
...
Tracer.prototype.buildTrace = function (traceInfo) {
  ...
  const asyncIntervals = resources.map(({ start, end }) => [start, end ?? traceInfo.endAt]);
