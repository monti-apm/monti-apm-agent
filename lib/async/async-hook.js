...
const hook = asyncHooks.createHook({
  init (asyncId, type, triggerAsyncId) {
    ...
    res.event = Kadira.tracer.event(info.trace, EventType.Async, pick(res, ['asyncId', 'stack', 'asyncId', 'triggerAsyncId', 'executionAsyncId', 'shouldBeSibling']));

    res.parentEvent = activeEvent;
