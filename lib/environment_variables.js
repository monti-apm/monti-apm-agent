...
Kadira._parseEnv._options = {
  ...
  MONTI_OPTIONS_LIVE_QUERY_POLLING_WINDOW_MS: {
    name: 'liveQueryPollingWindowMs',
    parser: Kadira._parseEnv.parseInt,
  },
  MONTI_OPTIONS_LIVE_QUERY_POLLING_MIN_CYCLES: {
    name: 'liveQueryPollingMinCycles',
    parser: Kadira._parseEnv.parseInt,
  },
  MONTI_OPTIONS_LIVE_QUERY_POLLING_DOCUMENT_BUDGET: {
    name: 'liveQueryPollingDocumentBudget',
    parser: Kadira._parseEnv.parseInt,
  },
