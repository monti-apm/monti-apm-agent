...
Tinytest.add('WaitTimeBuilder - register and build - clean _messageCache', function (test) {
...
Tinytest.add('WaitTimeBuilder - no inQueue', function (test) {
  const wtb = new WaitTimeBuilder();
  const session = {
    id: 'session-id',
    inQueue: null,
...
Tinytest.add('WaitTimeBuilder - register and build - cached _messageCache', function (test) {
  const wtb = new WaitTimeBuilder();
  const session = {
    id: 'session-id',
    inQueue: [{ id: 'a' }, { id: 'b' }],
...
Tinytest.add('WaitTimeBuilder - register and build - current processing', function (test) {
  const wtb = new WaitTimeBuilder();
  const session = {
    id: 'session-id',
    inQueue: [{ id: 'a' }, { id: 'b' }],
...
Tinytest.addAsync('WaitTimeBuilder - track waitTime - with unblock', function (test, done) {
  const wtb = new WaitTimeBuilder();
  const session = {
    id: 'session-id',
    inQueue: [{ id: 'a' }, { id: 'b' }],
...
Tinytest.addAsync('WaitTimeBuilder - track waitTime - without unblock', function (test, done) {
  const wtb = new WaitTimeBuilder();
  const session = {
    id: 'session-id',
    inQueue: [{ id: 'a' }, { id: 'b' }],
